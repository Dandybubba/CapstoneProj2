document.addEventListener("DOMContentLoaded", function() {
    ...
    secElem.innerHTML = secRem.toString().length == 2 ? secRem : '0${minRem}';
    progressBar.style.background =
        'conic-gradient(#9d0000 ${progressStart * degTravel}deg, #17171a ${progressStart * degTravel}deg)';

    if (progressStart == progressEnd) {
        progressBar.style.background =
        'conic-gradient( #00aa51 360deg, #00aa51 360deg)';
    ...
    if (!progress) {
        ...
        progressStart = 0;
        progressBar.style.background =
        'conic-gradient( #17171a 360deg, #17171a 360deg)';
    }
    }
